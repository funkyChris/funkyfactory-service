...
public class ClockServiceException extends FactoryException {
	 ...
	 */
	public ClockServiceException(String message, Exception rootCause) {
	 ...
	 * @param rootCause		primary exception that caused this exception (real cause of the problem)
	 */
	public ClockServiceException(Exception rootCause) {
		super(rootCause);
	}
	 ...
	 * @param message		human-readable explanation of the exception
	 */
	public ClockServiceException(String message) {
		super(message);
	}
